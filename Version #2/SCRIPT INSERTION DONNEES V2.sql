...
INSERT INTO public.passager (nom, prenom, date_naissance, id_ticket)
  VALUES ('Dufour' , 'Judith' , '1996-05-22', 1);

INSERT INTO public.passager (nom, prenom, date_naissance, id_ticket)
  VALUES ('Poirier' , 'Guy', '1986-10-10', 1 );
...
INSERT INTO public.ticket(id_trajet, prix, qrcode, date_achat, nombre_bagage, nombre_animal, telephone, mail)
  VALUES(1, 300, 1, 'AHEIFBG', '2019-10-10' , 0 , 1, 4187456680, 'troisdeuxun@haha.com');

INSERT INTO public.ticket(id_trajet, prix, qrcode, date_achat, nombre_bagage, nombre_animal, telephone, mail)
  VALUES(2, 300, 2, 'UGJANGT' , '2019-10-12' , 10 , 0 , 2, 4185551982, 'undeuxtrois@haha.com');
