...
INSERT INTO public.programmation (id_trajet, date_arrivee, date_depart, nom, annulation)
  VALUES (1 , '2019-10-12' , '2019-10-11' , 'Baie-Comeau Matane', False);

INSERT INTO public.programmation (id_trajet, date_arrivee, date_depart, nom, annulation)
  VALUES (2, '2019-10-14', '2019-10-14', 'Godbout Baie-Comeau', False);


INSERT INTO public.passager (nom, prenom, date_naissance)
  VALUES ('Dufour' , 'Judith' , '1996-05-22');

INSERT INTO public.passager (nom, prenom, date_naissance)
  VALUES ('Poirier' , 'Guy', '1986-10-10');

INSERT INTO public.passager (nom, prenom, date_naissance)
  VALUES ('Johnson' , 'Felix', '1999-02-04');


INSERT INTO public.acheteur (telephone, mail, id_passager)
  VALUES (4187456680, 'troisdeuxun@haha.com', 1);

INSERT INTO public.acheteur (telephone, mail, id_passager)
  VALUES (4185551982, 'undeuxtrois@haha.com', 2);
